...
//        http://www.mets-blog.com/java-pos-thermal-printer-example/
    ...
    public String setChinese(){
        final byte[] Feed = {28, 33, 78,27, 33, 48};
        String s = new String(Feed);
        commandSet += s;
        return new String(s);
    }
     public String setChineseU220(){
        final byte[] Feed = {28, 67, 48,27, 33, 48};
        String s = new String(Feed);
        commandSet += s;
        return new String(s);
    }
    
        public String chooseFontSize(int Options) {
        String s = "";
        final byte[] ChooseFontA = {29, 33, 48};
        final byte[] ChooseFontB = {29, 33, 49};
        final byte[] ChooseFontC = {29, 33, 55};
        final byte[] ChooseFontD = {29, 33, 56};
//        final byte[] ChooseFontA = {27, 33, 0};
//        final byte[] ChooseFontB = {27, 33, 47};
//        final byte[] ChooseFontC = {27, 33, 48};
//        final byte[] ChooseFontD = {27, 33, 56};
        switch(Options) {
            case 1:
            s = new String(ChooseFontA);
            break;
    ...
    public String setChineseMode(){
        final byte[] Feed = {28,38};
        String s = new String(Feed);
        commandSet += s;
        return new String(s);
    }
    public String removeChineseMode(){
        final byte[] Feed = {28,46};
        String s = new String(Feed);
        commandSet += s;
        return new String(s);
    }        
    ...
    public String setImage(){
        final byte[] Feed = {27,42};
        String s = new String(Feed);
        commandSet += s;
        return new String(s);
    } 
     public String clearBuffer(){
        final byte[] Feed = {16,20,8,1};
        String s = new String(Feed);
        commandSet += s;
        return new String(s);
    } 
    ...
    public String drawer_kick()
    {
        byte[] Feed = {27,112,0,60,120};
        String s = new String(Feed);
        commandSet +=s;
        return s;
    }
